<ul class="bx-menu-floating-blocks-wide bx-menu-object-<?php echo $a['object'];?> bx-clearfix">
    <?php if(is_array($a['bx_repeat:menu_items'])) for($i=0; $i<count($a['bx_repeat:menu_items']); $i++){ ?><li class="bx-menu-item bx-menu-item-<?php echo $a['bx_repeat:menu_items'][$i]['name'];?> bx-def-round-corners bx-def-color-bg-hl-hover bx-def-box-sizing <?php echo $a['bx_repeat:menu_items'][$i]['class_add'];?>">
        <a href="<?php echo $a['bx_repeat:menu_items'][$i]['link'];?>" target="<?php echo $a['bx_repeat:menu_items'][$i]['target'];?>" onclick="<?php echo $a['bx_repeat:menu_items'][$i]['onclick'];?>">
            ...
            <div class="bx-menu-floating-blocks-title bx-def-font-middle"><?php echo $a['bx_repeat:menu_items'][$i]['title'];?></div>
        </a>
